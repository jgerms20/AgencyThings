...
const seeds: SpaceSeed[] = [
  ...
  {
    id: "public-libraries-maker-spaces", name: "Public libraries and maker spaces", category: "Offline Culture", environment: "hybrid", ageContext: "Available across ages 3-17, with local programming, transport, and access shaping participation.", ageBands: allAges,
