...
const insightSeeds: InsightSeed[] = [
  ...
  { id: "media-short-form-shape", themeId: "media-influence", sequence: 2, title: "Short-form changes the shape of attention, not only its duration.", thesis: "Format and context matter alongside time spent.", tags: ["short-form", "attention"], sourceIds: ["common-sense-census-2025", "pew-teens-social-2024"] },
...
export const insights: Insight[] = insightSeeds.map((seed) => ({
  ...
  confidence: seed.id === "play-offline-rebound" ? "low" : "medium",
  confidenceReason: seed.id === "play-offline-rebound"
    ? "This is a directional, partial inference from growth in two narrower offline participation categories."
    : "The conclusion is supported by two distinct sources with explicit scope and limitations.",
  nuance: seed.id === "play-offline-rebound"
    ? "Youth sport and outdoor recreation are not all offline play, and increased participant counts do not prove that play frequency or access improved for every child."
    : "Evidence is mixed across ages, countries, platforms, and household circumstances.",
