...
function bespokeCoverage(seed: BespokeCoverageSeed): CultureShaper {
  const relation = seed.type === "artist"
  ...
  return additional({
    ...seed,
    audienceSegments: ["Audience not publicly segmented for Gen Alpha"],
    audience: {
    ...
    insightIds: seed.type === "athlete"
      ? ["play-competition-performance", "media-creators-templates"]
      : ["media-repeatable-formats", sharedMediaInsight],
...
function artistCoverage(seed: ArtistCoverage): BespokeCoverageSeed {
  return {
    ...seed,
    type: "artist",
    category: "Global music, performance, and fan culture",
    topics: ["music", "identity", "fandom"],
    formats: ["song", "music video", "live performance"],
    platforms: ["YouTube", "Spotify", "TikTok"],
    sourceId: "gwi-alpha-unfiltered",
    indicatorTiers: { reach: 4, participation: 3, commercialPull: 3, audienceCenter: 1 },
  };
}
...
function athleteCoverage(seed: AthleteCoverage): BespokeCoverageSeed {
  return {
    ...seed,
    type: "athlete",
    category: "Global sport, performance, and identity",
    topics: ["sports", "competition", "identity"],
    formats: ["live competition", "highlight", "sports interview"],
    platforms: ["YouTube", "Instagram", "live broadcast"],
    sourceId: "ap-sports-alpha-2026",
    indicatorTiers: { reach: 3, participation: 3, commercialPull: 3, audienceCenter: 1 },
  };
}
