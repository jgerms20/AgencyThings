...
1. Confirm the latest PR containing the linear upload workflow has been merged into the branch that Pages deploys.
...
4. Hard refresh the live page with `Shift` + browser refresh, or add `?v=2026-06-24` to the end of the URL.
5. Look for the badge at the top of the tool that says `Current build: linear upload workflow · 2026-06-24`. If that badge is missing, you are not on the newest deployed build.
